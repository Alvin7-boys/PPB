...
class CuciBasah : AppCompatActivity() {
    ...
    private var hargaKaos = 7000
    private var hargaCelana = 5000
    private var hargaJaket = 8000
    private var hargaSprei = 55000
    private var hargaKarpet = 150000
    ...
    private fun setInitLayout() {
        ...
        tvInfo.text = "Cuci basah merupakan proses pencucian pakaian biasa menggunakan air dan deterjen."
    }
