...
class DryClean : AppCompatActivity() {
    private lateinit var binding: ActivityLaundryBinding

    companion object {
        const val DATA_TITLE = "TITLE"
    }
    private var hargaKaos = 8000
    private var hargaCelana = 6000
    private var hargaJaket = 9000
    private var hargaSprei = 65000
    private var hargaKarpet = 200000
    ...
    private fun setInitLayout() {
        ...
        tvInfo.text = "Cuci kering adalah proses pencucian pakaian menggunakan bahan kimia dan teknik tertentu tanpa air."
